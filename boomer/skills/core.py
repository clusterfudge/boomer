...
from boomer.client.enclosure.api import EnclosureAPI
from boomer.configuration import ConfigurationManager
from boomer.dialog import DialogLoader
from boomer.filesystem import FileSystemAccess
...
THIRD_PARTY_SKILLS_DIR = "/opt/boomer/third_party"
...
class BoomerSkill(object):
    ...
    def __register_stop(self):
        ...
        self.emitter.on('boomer.stop', self.__handle_stop)
