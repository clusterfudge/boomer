...
from boomer.skills.core import create_skill_descriptor, load_skill
from boomer.skills.intent import create_skill as create_intent_skill
...
class SkillContainer(object):
    ...
    def __build_params(args):
        ...
        parser.add_argument("--config", default="./boomer.ini")
