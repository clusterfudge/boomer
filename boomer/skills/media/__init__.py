...
class MediaSkill(BoomerSkill):
    """
        ...
        skill. In addition event handlers to lower volume when boomer starts
    ...
    def _register_event_handlers(self):
        """
           ...
           while boomer is speaking.
        """
        self.emitter.on('boomer.media.stop', self._media_stop)
