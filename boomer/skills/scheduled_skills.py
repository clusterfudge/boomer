...
from boomer.skills import time_rules
...
class ScheduledSkill(BoomerSkill):
    """
...
class ScheduledCRUDSkill(ScheduledSkill):
    ...
    E.g. CRUD operations for a Reminder Skill
        #. "Boomer, list two reminders"
        #. "Boomer, list all reminders"
        #. "Boomer, delete one reminder"
        #. "Boomer, remind me to contribute to Boomer project"
    """
